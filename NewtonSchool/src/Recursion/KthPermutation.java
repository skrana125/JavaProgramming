/* For a number N we have N! unique permutations. Your task is to find the Kth
the smallest permutation when all N! permutations are arranged in the sorted order.
 */
package Recursion;
